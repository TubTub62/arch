...
hl.config({
    general = {
        ...
        col = {
            ...
            active_border   = { colors = {ACTIVE}, angle = 45 },
...
hl.bind(mainMod .. " + F5", hl.dsp.exec_cmd("pkexec brillo -q -U 10"))
hl.bind(mainMod .. " + F6", hl.dsp.exec_cmd("pkexec brillo -q -A 10"))
